...
//  */
// export class AssignmentControllerOld {
...
//     private cc: CS340Controller = Factory.getCourseController(this.ghc);
    ...
    //                 }
    //                 try {
    //                     // TODO: Return this as part of the response (?),
//                          // TODO: leaving it as is might be annoying for tests b/c of timing issues
    //                     // do this async
    ...
    //             githubTuple = await this.gha.addMembersToTeam(newGithubTeam.teamName,
    //                 newGithubTeam.githubTeamNumber, [student.githubId]);
    //         } else {
