...
export class GradesController {
	...
	public async getAllGrades(studentsOnly?: boolean): Promise<Grade[]> {
		...
		Log.info(
			"GradesController::getAllGrades() - done; # all: " +
				grades.length +
				"; # returned: " +
				returnGrades.length +
				"; took: " +
	...
	public async getReleasedGradesForPerson(personId: string): Promise<Grade[]> {
		...
		Log.trace(
			"GradesController::getReleasedGradesForPerson( " + personId + " ) - # grades: " + grades.length + "; took: " + Util.took(start)
		);
		return grades;
	}
	...
	public async saveGrade(grade: Grade): Promise<boolean> {
		Log.trace(
			"GradesController::saveGrade(..) - start; person: " + grade.personId + "; deliv: " + grade.delivId + "; score: " + grade.score
		);
		const start = Date.now();
		...
		Log.info(
			"GradesController::saveGrade(..) - saved; person: " +
				grade.personId +
				"; deliv: " +
				grade.delivId +
				"; score: " +
