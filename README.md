...
- [1. Classy Features](/docs/instructor/features.md#overview)
    ...
    - [1.4 Github & AutoTest Integration Behaviour](/docs/instructor/features.md#github-and-autotest-interactive-examples)
- [2. Getting Started](/docs/instructor/gettingstarted.md#overview)
    ...
    - [2.3 Front-end Customization (Optional)](/docs/instrcutor/gettingstarted.md#front-end-setup)
    - [2.4 Back-end Customization (Optional)](/docs/instructor/gettingstarted.md#back-end-setup)
- [3. AutoGrade Assignments](/docs/instructor/autograde.md#overview)
    - [3.1 Build an AutoGrade Container](/docs/instructor/autograde.md#build-a-container-checklist)
    - [3.2 Test an AutoGrade Container](/docs/instructor/container.md#test-a-container-checklist)
