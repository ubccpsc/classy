...
- [2. Operations](/docs/tech-staff/operations.md)
    ...
    - [2.2. Install Classy](/docs/tech-staff/install.md)
      ...
      - [2.2.2 Software Dependencies](/docs/tech-staff/install.md#software-dependencies)
      - [2.2.3 System Configuration](/docs/tech-staff/install.md#create-user-group)
      - [2.2.4 Create SSL Certificates](/docs/tech-staff/install.md#create-ssl-certificates)
      - [2.2.5 Configure Firewall Rules](/docs/tech-staff/install.md#create-firewall-rules)
      - [2.2.6 Configure Github](/docs/tech-staff/install.md#configure-github)
      - [2.2.7 Integrate Github](/docs/tech-staff/install.md#integrate-github)
    ...
    - [2.5 Patching](/docs/tech-staff/updates.md)
      - [2.5.1 VM OS](/docs/tech-staff/updates.md#os)
      - [2.5.2 Classy](/docs/tech-staff/updates.md#classy)
    ...
    - [2.9 Semester Transitions](/docs/tech-staff/operations.md#semestertransitions)
