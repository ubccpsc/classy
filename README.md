...
- [1. Classy Features](/docs/instructor/features.md#overview)
    ...
    - [1.3: Github & AutoTest Integration Behaviour](/docs/instructor/features.md#github-and-autotest-interactive-examples)
- [2. Getting Started](/docs/instructor/gettingstarted.md#overview)
    ...
    - [2.2. Front-end Customization (Optional)](/docs/instrcutor/gettingstarted.md#front-end-setup)
    - [2.3. Back-end Customization (Optional)](/docs/instructor/gettingstarted.md#back-end-setup)
...
- [2. Operations](/docs/tech-staff/operations.md)
    - [2.1. Request Server Resources](/docs/tech-staff/operations#serverresources.md)
    - [2.2. Install Classy](/docs/tech-staff/install.md)
      - [2.2.1 Installation Notes](/docs/tech-staff/install.md#installation-notes)
      - [2.2.1 Software Dependencies](/docs/tech-staff/install.md#software-dependencies)
      - [2.2.1 System Configuration](/docs/tech-staff/install.md#create-user-group)
      - [2.2.2 Create SSL Certificates](/docs/tech-staff/install.md#create-ssl-certificates)
      - [2.2.3 Configure Firewall Rules](/docs/tech-staff/install.md#create-firewall-rules)
      - [2.2.4 Configure Github](/docs/tech-staff/install.md#configure-github)
      - [2.2.5 Integrate Github](/docs/tech-staff/install.md#integrate-github)
    ...
    - [2.3 Starting/Stopping Classy](/docs/tech-staff/startstop.md#starting-classy)
      - [2.3.1 Building Classy](/docs/tech-staff/startstop.md#building-classy)
      - [2.3.2 Starting Classy](/docs/tech-staff/startstop.md#starting-classy)
      - [2.3.3 Stopping Classy](/docs/tech-staff/startstop.md#stopping-classy)
    - [2.4 Environmental Configuration](/docs/tech-staff/envconfig.md)
    - [2.5 Patching Classy Servers](/docs/tech-staff/gettingstarted.md#customviews)
    - [2.6 SSL Updates](/docs/tech-staff/operations.md#sslupdates)
    - [2.7 Updating Classy Code](/docs/tech-staff/gettingstarted.md#customcontroller)
    - [2.8 Starting/Stopping Classy](/docs/tech-staff/startstop.md)
    - [2.9 Health-Checks](/docs/tech-staff/operations.md#healthchecks)
    - [2.10 Back-ups](/docs/tech-staff/operations.md#backups)
    - [2.11 Semester Transitions](/docs/tech-staff/operations.md#semestertransitions)
