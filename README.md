...
- [2. Operations](/docs/tech-staff/operations.md)
    ...
    - [2.2. Installing Classy](/docs/tech-staff/install.md)
      - [2.2.1 Create User Group](/docs/tech-staff/install.md#create-user-group)
      - [2.2.2 Create SSL Certificates](/docs/tech-staff/install.md#create-ssl-certificates)
      - [2.2.3 Create Firewall Rules](/docs/tech-staff/install.md#create-firewall-rules)
